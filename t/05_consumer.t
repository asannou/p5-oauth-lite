...
my $auth_query3 = $c6->gen_auth_query('GET', q{http://example.org/}, undef, undef, { extra => 'foo' });
...
my $auth_query4 = $c6->gen_auth_query('GET', q{http://example.org/}, $token2, undef, { extra => 'foo' });
